...
public class TwoPair implements Handler{
  ...
  public void evaluate(Hand hand) {
    ...
    if (sortArray.get(0) == sortArray.get(1) && sortArray.get(2) == sortArray.get(3)){
      System.out.println("A3.TwoPair");
    }else if ( sortArray.get(0) == sortArray.get(1) && sortArray.get(3) == sortArray.get(4)){
      System.out.println("A3.TwoPair");
    }else if (   sortArray.get(1) == sortArray.get(2) && sortArray.get(3) == sortArray.get(4)){
      System.out.println("A3.TwoPair");
    }
    else{
      chain.evaluate(hand);
