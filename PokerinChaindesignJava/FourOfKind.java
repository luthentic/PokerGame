...
public class FourOfKind implements Handler{
  ...
  public void evaluate(Hand hand) {
    ...
    Collections.sort(sortArray);
     if (
            sortArray.get(0) == sortArray.get(1) && sortArray.get(1) == sortArray.get(2) && sortArray.get(2) == sortArray.get(3) ||
            sortArray.get(1) == sortArray.get(2) && sortArray.get(2) == sortArray.get(3) && sortArray.get(3) == sortArray.get(4)
     ){
       System.out.println("A3.FourOfKind");
     }else{
       chain.evaluate(hand);
     }
  }
